<table class="table table-bordered" id="table_tarifaVermelha">                                  
    <tbody>
        ...
        <tr>
            ...
            <td class="align_td"><?= $calculos["calculo"]["valores"]["totalKwh"] ?></td>
            <td class="align_td"><?= $calculos["calculo"]["ultimaTarifaInserida"]["tarifaVermelha"] ?></td>
            <td class="align_td"><?= $calculos["calculo"]["valores"]["vlVermelha"] ?></td>                                            
        </tr>
        ...
        <tr>
            ...
            <td class="align_td"></td>
            <td class="align_td"></td>
            <td class="align_td"><?= number_format($calculos["calculo"]["contas"]["totalVermelha"], 2) ?></td>                                            
        </tr>
    </tbody>
</table>